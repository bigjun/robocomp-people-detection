...
/** \mainpage RoboComp::velodyneDataManager
 *
 * \section intro_sec Introduction
 *
 * The velodyneDataManager component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/velodyneDataManager --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class velodyneDataManager : public RoboComp::Application
{
public:
	velodyneDataManager (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::velodyneDataManager::initialize()
{
...
int main(int argc, char* argv[])
{
	...
	::velodyneDataManager app(prefix);
