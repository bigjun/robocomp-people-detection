...
public:
	...
	virtual void robotInformation(const mapPose &robotPosition) = 0;
	virtual void goalInformation(const GoalInfo &goal) = 0;
	virtual void mapInformation(const MapInfo &info) = 0;
